    ...
    return (
      <Comp
        className={cn(
          ...
          {
            "bg-[var(--slate-12)] text-[var(--slate-1)] hover:bg-[var(--slate-11)]": variant === "default",
            "bg-red-500 text-white hover:bg-red-600": variant === "destructive",
            "border border-[var(--slate-6)] bg-transparent hover:bg-[var(--slate-5)] hover:text-[var(--slate-12)]": variant === "outline",
            "bg-[var(--slate-5)] text-[var(--slate-12)] hover:bg-[var(--slate-6)]": variant === "secondary",
